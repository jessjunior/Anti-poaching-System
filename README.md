The "97004.zip" folder contains two zipped folders: One contains files of an IoT system developed using Arduino and the other is a "KWS App" that is developed using Java.
